...
from ALPHA.core.patterns.neural_pattern import ComponentSignature, NeuralPattern
...
class TestNeuralPattern(unittest.TestCase):
    ...
    def test_pattern_enhancement(self):
        ...
        # Initial confidence
        initial_confidence = self.neural_pattern.pattern_confidence.get("test_pattern", 0.0)

        # Enhance pattern
        self.neural_pattern._enhance_pattern(test_pattern)

        # Check confidence changes
        new_confidence = self.neural_pattern.pattern_confidence.get("test_pattern", 0.0)
