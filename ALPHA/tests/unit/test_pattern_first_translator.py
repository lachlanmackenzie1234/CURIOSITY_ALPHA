...
from core.translation.pattern_first import PatternFirstTranslator, TranslationUnit
...
class TestPatternFirstTranslator(unittest.TestCase):
    ...
    def test_translation_unit_creation(self):
        ...
        unit = TranslationUnit(content=content, patterns=patterns, mappings=mappings)
    ...
    def test_binary_translation_roundtrip(self):
        ...
        binary = self.translator.translate_to_binary(
            self.fibonacci_sequence, preserve_patterns=True
        )

        # Translate back
        result = self.translator.translate_from_binary(binary, preserve_patterns=True)
    ...
    def test_pattern_preservation(self):
        ...
        binary_direct = self.translator.translate_to_binary(
            self.fibonacci_sequence, preserve_patterns=False
        )
